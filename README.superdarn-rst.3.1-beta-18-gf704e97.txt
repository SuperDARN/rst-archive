RST superdarn rst 3.1-beta-18-gf704e97 (2010) 
==========================================
R.J.Barnes
...
the file "rst/profile.superdarn-rst.linux.bash". Edit this file as
...
3.  OS X (Darwin) software package:
   "superdarn-rst.3.1-beta-18-gf704e97.pkg"
...
The software requires a number of environment variables that are defined in
the file "/Applications/rst/profile.superdarn-rst.darwin.bash". 
