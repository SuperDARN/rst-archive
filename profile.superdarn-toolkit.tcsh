...
setenv LIB_IQIDL ${HOMEPATH}/lib/libiqidl.1.so
...
#                                                                   #
#####################################################################
setenv MAKEBIN ${CODEBASE}/make/makebin.linux
setenv MAKELIB ${CODEBASE}/make/makelib.linux
setenv MAKELIBIDL ${CODEBASE}/make/makelibidl.linux
