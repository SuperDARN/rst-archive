...
function FitNativeRead,unit,prm,fit
  ...
  scltype=[1,1,2,2,2,2,2,2,2,2,3,2,2,2,2,2,2,2,2,4,4,2,2,2,2,2,2,3,2,2,2, $
           2,2,2,2,2,2,3,3,3,3,9,4,4,4]
  ...
  prm.cp=*(sclvec[sclid[2]].ptr)
  prm.stid=*(sclvec[sclid[3]].ptr)
  prm.time.yr=*(sclvec[sclid[4]].ptr)
  prm.time.mo=*(sclvec[sclid[5]].ptr)
  prm.time.dy=*(sclvec[sclid[6]].ptr)
  prm.time.hr=*(sclvec[sclid[7]].ptr)
  prm.time.mt=*(sclvec[sclid[8]].ptr)
  prm.time.sc=*(sclvec[sclid[9]].ptr)
  prm.time.us=*(sclvec[sclid[10]].ptr)
  prm.txpow=*(sclvec[sclid[11]].ptr)
  prm.nave=*(sclvec[sclid[12]].ptr)
  prm.atten=*(sclvec[sclid[13]].ptr)
  prm.lagfr=*(sclvec[sclid[14]].ptr)
  prm.smsep=*(sclvec[sclid[15]].ptr)
  prm.ercod=*(sclvec[sclid[16]].ptr)
  prm.stat.agc=*(sclvec[sclid[17]].ptr)
  prm.stat.lopwr=*(sclvec[sclid[18]].ptr)
  prm.noise.search=*(sclvec[sclid[19]].ptr)
  prm.noise.mean=*(sclvec[sclid[20]].ptr)
  prm.channel=*(sclvec[sclid[21]].ptr)
  prm.bmnum=*(sclvec[sclid[22]].ptr)  
  prm.scan=*(sclvec[sclid[23]].ptr)
  prm.offset=*(sclvec[sclid[24]].ptr)
  prm.rxrise=*(sclvec[sclid[25]].ptr)
  prm.intt.sc=*(sclvec[sclid[26]].ptr)
  prm.intt.us=*(sclvec[sclid[27]].ptr)
  prm.txpl=*(sclvec[sclid[28]].ptr)
  prm.mpinc=*(sclvec[sclid[29]].ptr)
  prm.mppul=*(sclvec[sclid[30]].ptr)
  prm.mplgs=*(sclvec[sclid[31]].ptr)
  prm.nrang=*(sclvec[sclid[32]].ptr)
  prm.frang=*(sclvec[sclid[33]].ptr)
  prm.rsep=*(sclvec[sclid[34]].ptr)
  prm.xcf=*(sclvec[sclid[35]].ptr)
  prm.tfreq=*(sclvec[sclid[36]].ptr)
  prm.mxpwr=*(sclvec[sclid[37]].ptr)
  prm.lvmax=*(sclvec[sclid[38]].ptr)
  prm.pulse[0:prm.mppul-1]=*(arrvec[arrid[0]].ptr)
  prm.lag[0:prm.mplgs-1,*]=(*(arrvec[arrid[1]].ptr))[*,*]
  prm.combf=*(sclvec[sclid[41]].ptr)

  fit.revision.major=*(sclvec[sclid[39]].ptr)
  fit.revision.minor=*(sclvec[sclid[40]].ptr)
  fit.noise.sky=*(sclvec[sclid[42]].ptr)
  fit.noise.lag0=*(sclvec[sclid[43]].ptr)
  fit.noise.vel=*(sclvec[sclid[44]].ptr)

  fit.pwr0[0:prm.nrang-1]=*(arrvec[arrid[3]].ptr)
...
function FitNativeWrite,unit,prm,fit
  ...
  s=DataMapMakeArray('ltab',prm.lag[0:prm.mplgs-1,*],arrvec)
