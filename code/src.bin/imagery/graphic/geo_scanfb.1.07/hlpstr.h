...
char *hlpstr[]={
"geo_scanfb - Plot an image from an sImage file containing scan orientated data.\n",
"geo_scanfb --help\n",
"geo_scanfb [options] filename\n",
"geo_scanfb -ppm [options] filename\n",
"geo_scanfb -ppmx [options] filename\n",
"geo_scanfb -xml [options] filename\n",
...
"-add\tDo not set the alpha channel.\n",
"-d yyyymmdd\tplot up to the scan with the date yyyymmdd.\n",
"-t hr:mn\tplot up to the scan with the time hr:mn.\n",
"-ex hr:mn\tplot scans up to the time hr:mn prior to end scan.\n",
"-fade fade\tset the fade factor to fade. The pixels are multiplies by fade after each scan is plotted so that the scans can be made to slowly fade into the background.\n",
...
"filename\tfilename of the sImage file\n",
