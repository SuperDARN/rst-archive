...
/* 
 $Log: socket.c,v $
 Revision 1.6  2007/03/13 14:47:10  code
 Only log time when a valid packet is received.

 Revision 1.5  2006/09/15 19:23:28  code
 Fixed types.

 Revision 1.4  2006/07/12 14:46:03  code
 Fixed missing header.

 Revision 1.3  2006/05/18 18:07:16  code
 Added code to record the time of the last record.

 Revision 1.2  2004/08/25 21:39:18  barnes
