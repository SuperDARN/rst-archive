...
"rtfittofitacf --help\n",
"rtfittofitacf [-t timeout] [-s stream] [-L logname] [-pf portname] [-if pidname] [-lp lport] host rport\n",
"rtfittofitacf -rpf [-t timeout] [-s stream] [-L logname [-pf portname] [-if pidname] [-lp lport] host rportname\n",
